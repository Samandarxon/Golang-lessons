...
func main() {
	...
	userController = userController.GenerateUser(1000)
	...
	categoryController = categoryController.GenerateCategory(1000)

	/* ***********************************************HomeWork Category Created*********************************************** */

	/* ***********************************************HomeWork Category GetList*********************************************** */

	categorys := categoryController.CategoryGetList(models.CategoryGetListRequest{
		OffSet: 0,
		Limit:  20,
	})
	...
	category := categoryController.CategoryGetById(models.CategoryPrimaryKey{Id: categorys.Categorys[2].Id})
